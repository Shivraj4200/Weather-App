...
function getWeatherReport(city) {
    ...
    fetch(`http://localhost:3000/weather?city=${city}`)  // fetch method fetching the data from  base url ...metric is used for unit in celcius......here i am appending the base url to get data by city name .  
